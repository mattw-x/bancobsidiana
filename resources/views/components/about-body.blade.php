<div class="relative isolate overflow-hidden bg-indigo-500 py-16 sm:py-12 lg:py-10">
    ...
    <div class="w-screen max-w-md flex-auto overflow-hidden rounded-3xl bg-gray-800 text-sm/6 outline-1 -outline-offset-1 outline-white/10">
      <div class="p-4">
        <div class="group relative flex gap-x-6 rounded-lg p-4 hover:bg-white/5">
          ...
          <div>
            ...
            <p class="mt-1 text-gray-400">Obtén una mejor comprensión de tus movimientos en línea</p>
          </div>
        </div>
        <div class="group relative flex gap-x-6 rounded-lg p-4 hover:bg-white/5">
          <div class="mt-1 flex size-11 flex-none items-center justify-center rounded-lg bg-gray-700/50 group-hover:bg-gray-700">
          ...
          <div>
            ...
            <p class="mt-1 text-gray-400">Interactúa directamente con tus tarjetas y realiza transacciones</p>
          </div>
        </div>
        <div class="group relative flex gap-x-6 rounded-lg p-4 hover:bg-white/5">
          <div class="mt-1 flex size-11 flex-none items-center justify-center rounded-lg bg-gray-700/50 group-hover:bg-gray-700">
          ...
          <div>
            ...
            <p class="mt-1 text-gray-400">Los datos de tus cuentas estarán seguros y protegidos</p>
          </div>
        </div>
        <div class="group relative flex gap-x-6 rounded-lg p-4 hover:bg-white/5">
          <div class="mt-1 flex size-11 flex-none items-center justify-center rounded-lg bg-gray-700/50 group-hover:bg-gray-700">
          ...
          <div>
            ...
            <p class="mt-1 text-gray-400">Conéctate con herramientas de terceros, paga a comercios y otros bancos</p>
          </div>
        </div>
        <div class="group relative flex gap-x-6 rounded-lg p-4 hover:bg-white/5">
          <div class="mt-1 flex size-11 flex-none items-center justify-center rounded-lg bg-gray-700/50 group-hover:bg-gray-700">
          ...
          <div>
            <a href="#" class="font-semibold text-white">
              Checkea el balance de tus cuentas
              <span class="absolute inset-0"></span>
            </a>
            <p class="mt-1 text-gray-400">Consulta el saldo y los movimientos de tus cuentas</p>
          </div>
        </div>
      </div>
      <div class="grid grid-cols-2 divide-x divide-white/10 bg-gray-700/50">
        <a href="#" class="flex items-center justify-center gap-x-2.5 p-3 font-semibold text-white hover:bg-gray-700/50">
          ...
          Solicitar TdC ObsiCreditos (BOC)
        </a>
        <a href="#" class="flex items-center justify-center gap-x-2.5 p-3 font-semibold text-white hover:bg-gray-700/50">
          <svg viewBox="0 0 20 20" fill="currentColor" data-slot="icon" aria-hidden="true" class="size-5 flex-none text-gray-500">
