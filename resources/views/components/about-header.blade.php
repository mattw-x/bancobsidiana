<div class="bg-gray-900">
    <header class="absolute inset-x-0 top-0 z-50">
        ...
        <div class="hidden lg:flex lg:gap-x-12">
            <a href="registro-cliente" class="text-sm/6 font-semibold text-white">Tarjetas</a>
            <a href="#" class="text-sm/6 font-semibold text-white">Servicios</a>
            <a href="#" class="text-sm/6 font-semibold text-white">Pagos Comercios</a>
            <a href="#" class="text-sm/6 font-semibold text-white">Preguntas Frecuentes</a>
        </div>
    ...
    <div class="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div class="text-center">
            ...
            <h1 class="text-5xl font-semibold tracking-tight text-balance text-white sm:text-7xl" style="font-family: 'Denvort', sans-serif;
  font-weight: 900;
  background: linear-gradient(90deg, #6C7A89 0%, #d9d9d9 25%, #bcb8ff 50%, #6C7A89 75%, #BDC3C7 100%);
  -webkit-background-clip: text;
  -webkit-text-fill-color: transparent;
  background-clip: text;">BancObsidiana</h1>
            <img src="/bo2-logo-bank-silver.png" alt="" class="h-40 w-auto" />
            </div>
